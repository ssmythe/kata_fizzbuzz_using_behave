...
Feature: FizzBuzz # features/fizzbuzz.feature:2
  ...
  Scenario: 1 = 1                       # features/fizzbuzz.feature:32
    ...
    When we run do_fizz with the number # features/steps/fizzbuzz_steps.py:13 0.000s
    Then we expect back "1"             # features/steps/fizzbuzz_steps.py:26 0.000s

  Scenario: 2 = 2                       # features/fizzbuzz.feature:37
    Given the number "2"                # features/steps/fizzbuzz_steps.py:5 0.000s
    When we run do_fizz with the number # features/steps/fizzbuzz_steps.py:13 0.000s
    Then we expect back "2"             # features/steps/fizzbuzz_steps.py:26 0.000s

  Scenario: 3 = Fizz                    # features/fizzbuzz.feature:42
    Given the number "3"                # features/steps/fizzbuzz_steps.py:5 0.000s
    When we run do_fizz with the number # features/steps/fizzbuzz_steps.py:13 0.000s
    Then we expect back "Fizz"          # features/steps/fizzbuzz_steps.py:26 0.000s

  Scenario: 5 = Buzz                    # features/fizzbuzz.feature:47
    Given the number "5"                # features/steps/fizzbuzz_steps.py:5 0.000s
    When we run do_fizz with the number # features/steps/fizzbuzz_steps.py:13 0.000s
    Then we expect back "Buzz"          # features/steps/fizzbuzz_steps.py:26 0.000s

  Scenario: 15 = FizzBuzz               # features/fizzbuzz.feature:52
    Given the number "15"               # features/steps/fizzbuzz_steps.py:5 0.000s
    When we run do_fizz with the number # features/steps/fizzbuzz_steps.py:13 0.000s
    Then we expect back "FizzBuzz"      # features/steps/fizzbuzz_steps.py:26 0.000s

  Scenario: foo = TypeError Exception    # features/fizzbuzz.feature:57
    Given the string "foo"               # features/steps/fizzbuzz_steps.py:9 0.000s
    When we run do_fizz with the string  # features/steps/fizzbuzz_steps.py:18 0.000s
    Then we expect a TypeError exception # features/steps/fizzbuzz_steps.py:30 0.000s
